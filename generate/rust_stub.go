...
func rustStub(cfg config.BuildConfig, out string) error {
	...
	// `pub mod` is a Rust IDENTIFIER, so it takes rust_module; the
	// #[link(wasm_import_module = …)] inside keeps the WIRE name. Both default
	// to import_module, so a config setting neither is unchanged.
	combined := "// Auto-generated by regexped. Do not edit.\n\n" + wrapRustModule(rustErrorPreamble()+allInner, cfg.RustModuleName())
	if out == "-" {
