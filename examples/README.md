...
| Use case | Environment | Language | Directory |
|---|---|---|---|
| IPv6 URL validation | wasmtime | Rust | [wasmtime/rust/url-ipv6](wasmtime/rust/url-ipv6) |
| Credential detection | wasmtime | Rust | [wasmtime/rust/secrets](wasmtime/rust/secrets) |
