...
wac plug target/wasm32-wasip2/release/your.wasm --plug regexps.wasm -o composed.wasm
...
Until `wac plug` runs, your component has an unsatisfied import and will not
instantiate — the component-model analogue of forgetting `regexped merge`.
